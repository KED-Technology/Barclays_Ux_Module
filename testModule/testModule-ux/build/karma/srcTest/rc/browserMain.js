...
(function () {
  ...
  require.config({
    ...
    paths: {
      ...
      nmodule: '/module',
      'nmodule/testModule': 'build/karma/src',
      'nmodule/testModuleTest': 'build/karma/srcTest',
  ...
  define('nmodule/testModule/rc/testModule.built.min');
  ...
  require(['niagara-test-server/karmaUtils', 'niagara-test-server/globals'], function (karmaUtils) {
     ...
     */
    //testOnly('rc/testModule');
    testOnly('');
    karmaUtils.setupAndRunSpecs({
      user: 'admin',
      pass: 'asdf1234',
      specs: ['nmodule/testModuleTest/rc/spec/allSpecs']
    }, function (err) {
      if (err) {
        console.error(err);
      }
