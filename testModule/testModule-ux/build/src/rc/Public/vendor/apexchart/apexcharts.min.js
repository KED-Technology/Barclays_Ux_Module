    ...
    m = function () {
      ...
      return r(t, [{
        ...
        value: function value(t) {
          ...
          }), "none" !== A.config.states.normal.filter.type) S.getDefaultFilter(z, s);else if (A.config.chart.dropShadow.enabled && k) {
      ...
      return r(t, [{
        ...
        value: function value(t, e) {
          ...
          if (this.annoCtx.invertAxis) {
            ...
            var h,
              c = r.globals.seriesYAxisMap[e.yAxisIndex][0];
  ...
  var M = {
      ...
      return r(t, [{
        ...
        value: function value(t, e) {
          ...
          if (s && r) {
            ...
            } else if (c) 0 == x.mod(b, v) ? S = v : v = S;else if (0 == x.mod(b, v)) S = v;else {
              S = b / (f = Math.ceil(b / v));
              var L = x.getGCD(b, v);
              b / L < a && (S = L), v = S;
            }
    ...
    vt = function () {
      ...
      return r(t, [{
        ...
        value: function value(t) {
          ...
          var y,
            w,
            k = (n += o * l) - (this.barCtx.isRangeBar ? 0 : v) + l / 2 + c.height / 2 + b - 3,
            A = "start",
    ...
    mt = function () {
      ...
      return r(t, [{
        ...
        key: "getGoalValues",
        value: function value(t, i, a, s, r, n) {
          var l = this,
            h = this.w,
            c = [],
            d = function d(e, s) {
        ...
        value: function value(t) {
          ...
          if (l && (w = l.indexOf(c.globals.seriesNames[p])), w > 0 && !c.globals.isXNumeric || w > 0 && c.globals.isXNumeric && c.globals.seriesX[p - 1][g] === c.globals.seriesX[p][g]) {
            var k,
              A,
              S,
              C = Math.min(this.yRatio.length + 1, p + 1);
    ...
    a.PathArray = function (t, e) {
      ...
      extend: {
        ...
        during: function during(t) {
          var e = this.last(),
            i = function i(_i2) {
              _i2.detail.situation == e && t.call(this, _i2.detail.pos, a.morph(_i2.detail.pos), _i2.detail.eased, e);
            };
