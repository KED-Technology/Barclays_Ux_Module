...
(function (h) {
  ...
  function gb(a) {
    ...
    if (a = a.aoSearchCols) for (var b = 0, c = a.length; b < c; b++) a[b] && J(_n.models.oSearch, a[b]);
  }
  function hb(a) {
  ...
  function ib(a) {
    ...
    h.extend(a.oBrowser, _n.__browser);
    a.oScroll.iBarWidth = _n.__browser.barWidth;
  }
  ...
  function Ga(a, b) {
    var c = _n.defaults.column,
      d = a.aoColumns.length,
      c = h.extend({}, _n.models.oColumn, c, {
    ...
    a.aoColumns.push(c);
    c = a.aoPreSearchCols;
    c[d] = h.extend({}, _n.models.oSearch, c[d]);
    la(a, d, h(b).data());
  }
  function la(a, b, c) {
    var b = a.aoColumns[b],
    ...
    c !== k && null !== c && (hb(c), J(_n.defaults.column, c, !0), c.mDataProp !== k && !c.mData && (c.mData = c.mDataProp), c.sType && (b._sManualType = c.sType), c.className && !c.sClass && (c.sClass = c.className), c.sClass && e.addClass(c.sClass), h.extend(b, c), F(b, c, "sWidth", "sWidthOrig"), c.iDataSort !== k && (b.aDataSort = [c.iDataSort]), F(b, c, "aDataSort"));
    var g = b.mData,
      j = S(g),
        ...
        if ("" !== f) {
          ...
          for (var i = 0, l = j.length; i < l; i++) {
            ...
            if (f) {
              ...
              if (h.isArray(a)) {
                i = 0;
                for (l = a.length; i < l; i++) g.push(_c(a[i], b, j));
              }
      ...
      var _b = function b(a, d, e) {
        ...
        for (var g, j, i = 0, l = e.length - 1; i < l; i++) {
          ...
          if (g) {
            ...
            if (h.isArray(d)) {
              j = 0;
              for (l = d.length; j < l; j++) f = {}, _b(f, d[j], g), a[e[i]].push(f);
            } else a[e[i]] = d;
            return;
          }
  ...
  function mb(a) {
    ...
    i && (e = h("<tr/>").appendTo(g));
    b = 0;
    for (c = m.length; b < c; b++) f = m[b], d = h(f.nTh).addClass(f.sClass), i && d.appendTo(e), a.oFeatures.bSort && (d.addClass(f.sSortingClass), !1 !== f.bSortable && (d.attr("tabindex", a.iTabIndex).attr("aria-controls", a.sTableId), Oa(a, f.nTh, b))), f.sTitle != d[0].innerHTML && d.html(f.sTitle), Pa(a, "header")(a, d, f, l);
    i && fa(a.aoHeader, g);
  ...
  function pb(a) {
    ...
    for (var f = a.sDom.split(""), g, j, i, l, m, q, k = 0; k < f.length; k++) {
      ...
      if ("<" == j) {
        ...
        e.append(i);
        e = h(i);
      } else if (">" == j) e = e.parent();else if ("l" == j && d.bPaginate && d.bLengthChange) g = qb(a);else if ("f" == j && d.bFilter) g = rb(a);else if ("r" == j && d.bProcessing) g = sb(a);else if ("t" == j) g = tb(a);else if ("i" == j && d.bInfo) g = ub(a);else if ("p" == j && d.bPaginate) g = vb(a);else if (0 !== _n.ext.feature.length) {
        i = _n.ext.feature;
        q = 0;
  ...
  function Ab(a) {
    for (var b = _n.ext.search, c = a.aiDisplay, d, e, f = 0, g = b.length; f < g; f++) {
  ...
  function Bb(a) {
    var b = a.aoColumns,
      ...
      i,
      h,
      m = _n.ext.type.search;
    c = !1;
    d = 0;
    for (f = a.aoData.length; d < f; d++) if (h = a.aoData[d], !h._aFilterData) {
      j = [];
      e = 0;
      for (g = b.length; e < g; e++) c = b[e], c.bSearchable ? (i = B(a, d, e, "filter"), m[c.sType] && (i = m[c.sType](i)), null === i && (i = ""), "string" !== typeof i && i.toString && (i = i.toString())) : i = "", i.indexOf && -1 !== i.indexOf("&") && (wa.innerHTML = i, i = Yb ? wa.textContent : wa.innerText), i.replace && (i = i.replace(/[\r\n\u2028]/g, "")), j.push(i);
      h._aFilterData = j;
  ...
  function Y(a) {
    ...
    for (a = 0; a < l.length; a++) {
      ...
      for (c = f.length; b < c; b++) g = f[b], j = e[g].sType || "string", l[a]._idx === k && (l[a]._idx = h.inArray(l[a][1], e[g].asSorting)), d.push({
        ...
        index: l[a]._idx,
        type: j,
        formatter: _n.ext.type.order[j + "-pre"]
      });
    }
    return d;
  }
  ...
  function Jb(a, b) {
    var c = a.aoColumns[b],
      d = _n.ext.order[c.sSortDataType],
      e;
    d && (e = d.call(a.oInstance, a, b, ca(a, b)));
    for (var f, g = _n.ext.type.order[c.sType + "-pre"], j = 0, i = a.aoData.length; j < i; j++) if (c = a.aoData[j], c._aSortData || (c._aSortData = []), !c._aSortData[b] || d) f = d ? e[j] : B(a, j, b, "sort"), c._aSortData[b] = g ? g(f) : f;
  }
  function za(a) {
  ...
  function Lb(a, b, c) {
    var d,
      ...
      b = function b(_b2) {
        if (_b2 && _b2.time) {
          var g = t(a, "aoStateLoadParams", "stateLoadParams", [a, _b2]);
          if (-1 === h.inArray(!1, g) && (g = a.iStateDuration, !(0 < g && _b2.time < +new Date() - 1E3 * g) && !(_b2.columns && f.length !== _b2.columns.length))) {
            ...
            _b2.search !== k && h.extend(a.oPreviousSearch, Db(_b2.search));
            if (_b2.columns) {
              d = 0;
              for (e = _b2.columns.length; d < e; d++) g = _b2.columns[d], g.visible !== k && (f[d].bVisible = g.visible), g.search !== k && h.extend(a.aoPreSearchCols[d], Db(g.search));
            }
            t(a, "aoStateLoaded", "stateLoaded", [a, _b2]);
          }
        }
        c();
      };
  ...
  function K(a, b, c, d) {
    ...
    if (b) E.console && console.log && console.log(c);else if (b = _n.ext, b = b.sErrMode || b.errMode, a && t(a, null, "error", [a, d, c]), "alert" == b) alert(c);else {
  ...
  function Nb(a) {
    return function () {
      var b = [Aa(this[_n.ext.iApiIndex])].concat(Array.prototype.slice.call(arguments));
      return _n.ext.internal[a].apply(this, b);
    };
  }
  var _n = function n(a) {
      this.$ = function (a, b) {
      ...
      for (var e in _n.ext.internal) e && (this[e] = Nb(e));
      this.each(function () {
        var e = {},
          g = 1 < d ? Ya(e, a, !0) : a,
          j = 0,
        ...
        if ("table" != this.nodeName.toLowerCase()) K(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);else {
          ...
          if (null === e || "" === e) this.id = e = "DataTables_Table_" + _n.ext._unique++;
          var p = h.extend(!0, {}, _n.models.oSettings, {
          ...
          ib(p);
          var s = p.oClasses;
          h.extend(s, _n.ext.classes, g.oClasses);
          q.addClass(s.sTable);
  ...
  _r.extend = function (a, b, c) {
    if (c.length && b && (b instanceof _r || b.__dt_wrapper)) {
      ...
      d = 0;
      for (e = c.length; d < e; d++) f = c[d], b[f.name] = "function" === f.type ? g(a, f.val, f) : "object" === f.type ? {} : f.val, b[f.name].__dt_wrapper = !0, _r.extend(a, b[f.name], f.propExt);
    }
  };
  _r.register = o = function o(a, b) {
    if (h.isArray(a)) for (var c = 0, d = a.length; c < d; c++) _r.register(a[c], b);else for (var e = a.split("."), f = Tb, g, j, c = 0, d = e.length; c < d; c++) {
  ...
  o("tables()", function (a) {
    return a !== k && null !== a ? new _r(_Ub(a, this.context)) : this;
  });
  o("table()", function (a) {
    var a = this.tables(a),
      b = a.context;
  ...
  o("row().child()", function (a, b) {
    ...
    if (!0 === a) this.child.show();else if (!1 === a) eb(this);else if (c.length && this.length) {
      var d = c[0],
        ...
        e = [],
        _f = function f(a, b) {
          if (h.isArray(a) || a instanceof h) for (var c = 0, k = a.length; c < k; c++) _f(a[c], b);else a.nodeName && "tr" === a.nodeName.toLowerCase() ? e.push(a) : (c = h("<tr><td/></tr>").addClass(b), h("td", c).addClass(b).html(a)[0].colSpan = W(d), e.push(c[0]));
        };
      _f(a, b);
  ...
  _n.versionCheck = _n.fnVersionCheck = function (a) {
    for (var b = _n.version.split("."), a = a.split("."), c, d, e = 0, f = a.length; e < f; e++) if (c = parseInt(b[e], 10) || 0, d = parseInt(a[e], 10) || 0, c !== d) return c > d;
    return !0;
  };
  _n.isDataTable = _n.fnIsDataTable = function (a) {
    var b = h(a).get(0),
      c = !1;
    if (a instanceof _n.Api) return !0;
    h.each(_n.settings, function (a, e) {
  ...
  _n.tables = _n.fnTables = function (a) {
    var b = !1;
    h.isPlainObject(a) && (b = a.api, a = a.visible);
    var c = h.map(_n.settings, function (b) {
      if (!a || a && h(b.nTable).is(":visible")) return b.nTable;
    });
    return b ? new _r(c) : c;
  };
  _n.camelToHungarian = J;
  o("$()", function (a, b) {
  ...
  o("destroy()", function (a) {
    ...
    return this.iterator("table", function (b) {
      ...
      c = h.inArray(b, _n.settings);
      -1 !== c && _n.settings.splice(c, 1);
    });
  });
  ...
  _n.defaults = {
    ...
    oSearch: h.extend({}, _n.models.oSearch),
    sAjaxDataProp: "data",
    sAjaxSource: null,
    sDom: "lfrtip",
    searchDelay: null,
  ...
  _n.ext = v = {
    ...
    _unique: 0,
    fnVersionCheck: _n.fnVersionCheck,
    iApiIndex: 0,
    oJUIClasses: {},
    sVersion: _n.version
  };
  ...
  h.extend(_n.ext.type.detect, [function (a, b) {
  ...
  h.fn.dataTable = _n;
  _n.$ = h;
  h.fn.dataTableSettings = _n.settings;
  h.fn.dataTableExt = _n.ext;
  h.fn.DataTable = function (a) {
    return h(this).dataTable(a).api();
  };
  h.each(_n, function (a, b) {
    h.fn.DataTable[a] = b;
  });
