...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    requirejs: {
      compile: {
        options: {
          ...
          name: 'testModule', // Entry point file name (e.g., main.js)
          out: 'build/src/rc/testModule.built.min.js', // Output bundled file
    ...
    niagara: {
          station: {
            stationName: 'testModule',
            forceCopy: true,
            sourceStationFolder: './srcTest/rc/stations/testModuleUnitTest'
          }
        }
  });
