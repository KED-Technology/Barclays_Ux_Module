...
define(['bajaux/spandrel', 'bajaux/mixin/subscriberMixIn', 'jquery', 'Promise'], function (spandrel, subscriberMixIn, $, Promise) {
  ...
  var BUTTON_CLASS = 'BarclaysWidget-button';
   ...
   */
  var BarclaysWidget = /*#__PURE__*/function (_spandrel) {
    function BarclaysWidget(params) {
      var _this;
      _classCallCheck(this, BarclaysWidget);
      _this = _callSuper(this, BarclaysWidget, [{
        params: params,
     ...
     */
    _inherits(BarclaysWidget, _spandrel);
    return _createClass(BarclaysWidget, [{
      key: "doInitialize",
      value: function doInitialize(dom) {
        var _this2 = this;
        dom.on('click', '.BarclaysWidget-content button', function (e) {
          var target = $(e.target);
      ...
      value: function getSelectedSlotName() {
        var selectedButton = this.jq().find('.BarclaysWidget-content .' + BUTTON_CLASS + '.' + SELECTED_CLASS);
