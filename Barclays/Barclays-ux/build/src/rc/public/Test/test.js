  ...
  var options = {
    ...
    tooltip: {
      ...
      custom: function custom(_ref) {
        ...
        return "<div>".concat(name, ": ").concat(value, "%</div>"); // Show name and value in tooltip
      }
    },
    responsive: [{
      breakpoint: 480,
...
function lineChart1() {
  ...
  if (startDateValue && endDateValue) {
    ...
    var _generateChartData2 = function _generateChartData2() {
      var chartData = [];
...
function occupacyLine() {
  ...
  if (startDateValue && endDateValue) {
    var _generateChartData4 = function _generateChartData4(startDate, endDate) {
      var chartData = [];
    ...
    var chartData = _generateChartData4(startDate, endDate);
    if (chartData.length === 0) {
      alert('No data to display for the selected range');
      return;
    }
