...
(function () {
  ...
  require.config({
    ...
    paths: {
      ...
      nmodule: '/module',
      'nmodule/Barclays': 'build/karma/src',
      'nmodule/BarclaysTest': 'build/karma/srcTest',
  ...
  define('nmodule/Barclays/rc/Barclays.built.min');
  ...
  require(['niagara-test-server/karmaUtils', 'niagara-test-server/globals'], function (karmaUtils) {
     ...
     */
    //testOnly('rc/Barclays');
    testOnly('');
    karmaUtils.setupAndRunSpecs({
      user: 'admin',
      pass: 'asdf1234',
      specs: ['nmodule/BarclaysTest/rc/spec/allSpecs']
    }, function (err) {
      if (err) {
        console.error(err);
      }
