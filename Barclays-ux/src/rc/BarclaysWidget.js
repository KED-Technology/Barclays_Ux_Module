            ...
            var options = {
                ...
                plotOptions: {
                    radialBar: {
                        ...
                        startAngle: -180,
                        endAngle: 90,
                        track: { background: '#f5f5f5', strokeWidth: '100%', margin: 4 },
                        hollow: { margin: 0, size: '50%', background: 'transparent' },
                        dataLabels: {
                            show: true,
                            name: { show: true, fontSize: '30px', fontWeight: 'bold', color: '#000000', formatter: () => 'Total' },
                            value: { show: true, fontSize: '30px', fontWeight: 'bold', color: '#000000', formatter: () => totalValue.toFixed(2) },
                            total: { show: true, label: 'Total', fontSize: '30px', fontWeight: 'bold', color: '#000000', formatter: () => totalValue.toFixed(2) }
                        }
                    }
                },
                ...
                legend: { show: true, floating: true, fontSize: '16px', position: 'right', offsetX: 10, offsetY: -20, labels: { useSeriesColors: true }, markers: { size: 0 }, itemMargin: { vertical: 1 } },
                tooltip: {
                    enabled: true,
                ...
                responsive: [{ breakpoint: 480, options: { legend: { show: true } } }]
            };
