        ...
        return Object(a.c)(t, e), t.prototype.makeBackwards = function () {
          ...
          if (e.prototype.validate.call(this), !this.isTemplate) {
            ...
            if (this.middleLine.tensionX = k, this.middleLine.tensionY = L, m.isNumber(y) && m.isNumber(o) && m.isNumber(l) && m.isNumber(s) && m.isNumber(c)) {
              ...
              _ == V && (_ += .01), this.middleLine.segments = [[{
                x: T,
                y: V
              }, {
                x: M,
    ...
    var yt = i("Q4nc"),
      ...
      mt = function (e) {
        ...
        return Object(a.c)(t, e), t.prototype.createSlice = function () {
          ...
          e.isMeasured = !1, e.defaultState.properties.scale = 1, e.observe("scale", this.handleSliceScale, this), e.observe(["dx", "dy", "x", "y"], this.handleSliceMove, this), e.tooltipText = "{category}: {value.percent.formatNumber('#.#p')} ({value.value})", e.states.create("hover").properties.expandDistance = .2;
