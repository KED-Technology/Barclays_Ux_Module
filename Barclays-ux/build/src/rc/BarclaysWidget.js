...
'baja!' // Optionally include BajaScript if needed
  ...
  return function () {
    ...
    function _disposeChartCo() {
      _disposeChartCo = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(newChartFunction) {
    ...
    function _pieChart() {
      _pieChart = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              scopeValues = [];
              scopes = ['scope1date', 'scope2date', 'scope3date'];
              _i = 0, _scopes = scopes;
            case 7:
                ...
                tooltip: {
                  ...
                  custom: function custom(_ref) {
                    var series = _ref.series,
                      ...
                      w = _ref.w;
                    var name = w.globals.labels[seriesIndex];
                    var value = series[seriesIndex];
                    value = value.toFixed(2);
                    var backgroundColors = ['#FFB22C', '#A4CE95', '#FFD93D'];
                    var backgroundColor = backgroundColors[seriesIndex] || '#F7F7F7';
