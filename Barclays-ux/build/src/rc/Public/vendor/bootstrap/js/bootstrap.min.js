...
!function (t, e) {
  ...
  var i = {
    ...
    _p = function p(t) {
      ...
      return t instanceof ShadowRoot ? t : t.parentNode ? _p(t.parentNode) : null;
    },
    f = function f() {},
    m = function m(t) {
    ...
    E = function E(t, e) {
      ...
      var n = !1;
      var _o = function o(_ref3) {
        var s = _ref3.target;
        s === e && (n = !0, e.removeEventListener("transitionend", _o), w(t));
      };
      e.addEventListener("transitionend", _o), setTimeout(function () {
        n || l(e);
      }, i);
    },
    ...
    var d = S(r, e.replace(T, "")),
      u = o ? function (t, e, s) {
        return function i(n) {
          ...
          for (var _r = n.target; _r && _r !== this; _r = _r.parentNode) for (var _a = o.length; _a--;) if (o[_a] === _r) return n.delegateTarget = _r, i.oneOff && B.off(t, n.type, e, s), s.apply(_r, [n]);
          return null;
        };
      }(t, s, i) : function (t, e) {
        return function s(i) {
  ...
  var nt = /*#__PURE__*/function (_q4) {
    function nt(t, e) {
      ...
      _this8 = _callSuper(this, nt, [t]), _this8._isTransitioning = !1, _this8._config = _this8._getConfig(e), _this8._triggerArray = i.find("[data-bs-toggle=\"collapse\"][href=\"#".concat(_this8._element.id, "\"],[data-bs-toggle=\"collapse\"][data-bs-target=\"#").concat(_this8._element.id, "\"]"));
      ...
      for (var _t5 = 0, _e6 = s.length; _t5 < _e6; _t5++) {
        ...
        null !== _n2 && _o4.length && (_this8._selector = _n2, _this8._triggerArray.push(_e7));
      }
  ...
  var pt = /*#__PURE__*/function (_q5) {
    function pt(t, e) {
      ...
      _this12 = _callSuper(this, pt, [t]), _this12._popper = null, _this12._config = _this12._getConfig(e), _this12._menu = _this12._getMenuElement(), _this12._inNavbar = _this12._detectNavbar(), _this12._addEventListeners();
      return _this12;
    }
    _inherits(pt, _q5);
    return _createClass(pt, [{
      ...
      key: "dispose",
      value: function dispose() {
        this._popper && this._popper.destroy(), _superPropGet(pt, "dispose", this, 3)([]);
      }
    }, {
      key: "update",
  ...
  var wt = /*#__PURE__*/function (_q6) {
    function wt(t, e) {
      ...
      _this19 = _callSuper(this, wt, [t]), _this19._config = _this19._getConfig(e), _this19._dialog = i.findOne(".modal-dialog", _this19._element), _this19._backdrop = _this19._initializeBackDrop(), _this19._isShown = !1, _this19._ignoreBackdropClick = !1, _this19._isTransitioning = !1, _this19._scrollBar = new ft();
      return _this19;
    }
    _inherits(wt, _q6);
    return _createClass(wt, [{
      ...
      value: function dispose() {
        ...
        }), this._backdrop.dispose(), _superPropGet(wt, "dispose", this, 3)([]), B.off(document, "focusin.bs.modal");
      }
    }, {
      key: "handleUpdate",
  ...
  var Tt = /*#__PURE__*/function (_q7) {
    function Tt(t, e) {
      ...
      _this30 = _callSuper(this, Tt, [t]), _this30._config = _this30._getConfig(e), _this30._isShown = !1, _this30._backdrop = _this30._initializeBackDrop(), _this30._addEventListeners();
      return _this30;
    }
    _inherits(Tt, _q7);
    return _createClass(Tt, [{
      ...
      key: "dispose",
      value: function dispose() {
        this._backdrop.dispose(), _superPropGet(Tt, "dispose", this, 3)([]), B.off(document, "focusin.bs.offcanvas");
      }
    }, {
      key: "_getConfig",
      value: function _getConfig(t) {
  ...
  var jt = /*#__PURE__*/function (_q8) {
    function jt(t, e) {
      ...
      _this36 = _callSuper(this, jt, [t]), _this36._isEnabled = !0, _this36._timeout = 0, _this36._hoverState = "", _this36._activeTrigger = {}, _this36._popper = null, _this36._config = _this36._getConfig(e), _this36.tip = null, _this36._setListeners();
      return _this36;
    }
    _inherits(jt, _q8);
    return _createClass(jt, [{
      ...
      key: "dispose",
      value: function dispose() {
        clearTimeout(this._timeout), B.off(this._element.closest(".modal"), "hide.bs.modal", this._hideModalHandler), this.tip && this.tip.remove(), this._popper && this._popper.destroy(), _superPropGet(jt, "dispose", this, 3)([]);
      }
    }, {
      key: "show",
      value: function show() {
  ...
  var Wt = /*#__PURE__*/function (_jt) {
    ...
    return _createClass(Wt, [{
      ...
      key: "getTipElement",
      value: function getTipElement() {
        return this.tip || (this.tip = _superPropGet(Wt, "getTipElement", this, 3)([]), this.getTitle() || i.findOne(".popover-header", this.tip).remove(), this._getContent() || i.findOne(".popover-body", this.tip).remove()), this.tip;
      }
    }, {
      key: "setContent",
      value: function setContent() {
  ...
  var Ft = /*#__PURE__*/function (_q9) {
    function Ft(t, e) {
      var _this42;
      _classCallCheck(this, Ft);
      _this42 = _callSuper(this, Ft, [t]), _this42._scrollElement = "BODY" === _this42._element.tagName ? window : _this42._element, _this42._config = _this42._getConfig(e), _this42._selector = "".concat(_this42._config.target, " .nav-link, ").concat(_this42._config.target, " .list-group-item, ").concat(_this42._config.target, " .dropdown-item"), _this42._offsets = [], _this42._targets = [], _this42._activeTarget = null, _this42._scrollHeight = 0, B.on(_this42._scrollElement, "scroll.bs.scrollspy", function () {
    ...
    return _createClass(Ft, [{
      ...
      key: "dispose",
      value: function dispose() {
        B.off(this._scrollElement, ".bs.scrollspy"), _superPropGet(Ft, "dispose", this, 3)([]);
      }
    }, {
      key: "_getConfig",
      value: function _getConfig(t) {
  ...
  var Ut = /*#__PURE__*/function (_q10) {
    function Ut() {
      ...
      return _callSuper(this, Ut, arguments);
    }
    _inherits(Ut, _q10);
  ...
  var Qt = /*#__PURE__*/function (_q11) {
    function Qt(t, e) {
      ...
      _this46 = _callSuper(this, Qt, [t]), _this46._config = _this46._getConfig(e), _this46._timeout = null, _this46._hasMouseInteraction = !1, _this46._hasKeyboardInteraction = !1, _this46._setListeners();
      return _this46;
    }
    _inherits(Qt, _q11);
    return _createClass(Qt, [{
      ...
      key: "dispose",
      value: function dispose() {
        this._clearTimeout(), this._element.classList.contains("show") && this._element.classList.remove("show"), _superPropGet(Qt, "dispose", this, 3)([]);
      }
    }, {
      key: "_getConfig",
      value: function _getConfig(t) {
